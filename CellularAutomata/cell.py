...
#
#     print(" ")
#     print(rcnv_k.index(rcnvk))
#     print(rcnvk)
#
#     rule_call = map(length, width, rcnvk, base, start, direction, cell_patterns, path, 1, 1)
...
#
#         m = map(length, x, y, base, start, direction, cell_patterns, path)
#
#
# for x in range(1, 33):
#
#     print(" ")
#     for y in range(1, 256):
#         print(str(x) + "_" + str(y) + " | " + str(cell_patterns[(x, y)]))
#
#
# filename = 'cell_patterns'
# outfile = open(filename, 'wb')
# pickle.dump(cell_patterns, outfile)
# outfile.close()

# for key in list(c_i_s.keys()):
#
#     print(key)
#     print(list(c_i_s.keys()).index(key))
#
#     m = map(length, key[0], key[1], base, start, direction, cell_patterns, path)
