...
BLACK_PIXEL_1 = pygame.image.load(os.path.join('assets', 'black-200.png')).convert()
WHITE_PIXEL_1 = pygame.image.load(os.path.join('assets', 'grey-3-1.png')).convert()
M_GREEN_PIXEL_1 = pygame.image.load(os.path.join('assets', 'cyan-200.png')).convert()
BLUE_PIXEL_1 = pygame.image.load(os.path.join('assets', 'cyan-200.png')).convert_alpha()
...
BLUE_PIXEL_0 = pygame.image.load(os.path.join('assets', 'black-200.png')).convert_alpha()
...
def main():
    ...
    def mitosis(i, r, color, rc, row):
        ...
        # print(cells)
        # print(cells[r-1])
        # print(type(cells[r-1]))
        # print(len(cells[r-1]))
        # print("cells")
        # for cel in cells[r-1]:
        #     print(cel)
        ...
        if r > 0:
            ...
            if r_c == 1:
                ...
                if row[0, i] == 0:
                    ...
                    cells[r].append(cell)
                if row[0, i] == 1:
                    cell = Cell(1 * BLUE_PIXEL_0.get_width() * i, -BLUE_PIXEL_0.get_height() + 2, 'blue_1')
                    cells[r].append(cell)
    ...
    while run:
            ...
            if len(cells[r]) == 0:
                ...
                if line in page:
                    ...
                    if rand == 1:
                        ...
                        rand = random.randrange(0, (base ** view))
                        print("rand")
                        print(rand)
                ...
                # cellular automata adversarial scenario
                if step != caas_step:
                    print("steps")
                    print(step)
                    print(caas_step)
                    ...
                    if step > cell_rows + 1:
                        ...
                        for call in rc:
                            if call not in calls and i_rule[call] == 1:
                                calls[call] = 1
                            if i_rule[call] == 1:
                                calls[call] += 1
                        ...
                        if len(calls) > 0:
                            i_rule[calls[0]] = 0
                            d_rule[list(d_rule.keys())[calls[0]]]
        ...
        for r in range(cell_rows):
            for cell in cells[r][:]:
                cell.move(cell_vel)
                if cell.y + cell.get_height() > HEIGHT + BLUE_PIXEL_0.get_height():
                    cells[r].remove(cell)
