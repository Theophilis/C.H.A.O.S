otData = [
	...
	('ChainPosRule', [
		...
		('uint16', 'LookAheadGlyphCount', None, None, 'Total number of glyphs in the ari ahead sequence (number of glyphs to be matched after the input sequence)'),
	...
	('ChainPosClassRule', [
		...
		('uint16', 'LookAheadGlyphCount', None, None, 'Total number of classes in the ari ahead sequence (number of classes to be matched after the input sequence)'),
