...
def stream(front, back, front_row, back_row, max_steps, roam):
    ...
    infile = open("organized-rules/rulidex-2-3", "rb")
    rulidex = pickle.load(infile)
    infile.close
    ...
    if f_c > b_c:
        ...
        rule_list = rulidex[roams[0]]['shrink'] + rulidex[roams[1]]['shrink'] + rulidex[roams[2]]['shrink']
    ...
    if f_c < b_c:
        ...
        rule_list = rulidex[roams[0]]['grow'] + rulidex[roams[1]]['grow'] + rulidex[roams[2]]['grow']
    ...
    if f_c == b_c:
        ...
        rule_list = rulidex[roams[roam]]['stagnate'] + rulidex[roams[0]]['stagnate']
        ...
        if fb in polar_paths:
            ...
            if len(path[fb][1]) == 0 and len(path[fb][2]) == 0 and len(path[fb][3]) == 0:
                ...
                while len(routes) == 0:
                    ...
                    #one step
                    routes = stream(front, back, front_row, back_row, max_steps, roam)
